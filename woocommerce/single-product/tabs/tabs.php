...
if ( ! empty( $tabs ) ) : ?>
	...
	<div class="woocommerce-tabs wc-tabs-wrapper">
		...
		<?php foreach ( $tabs as $key => $tab ) : ?>
			<div class="card woocommerce-Tabs-panel woocommerce-Tabs-panel--<?php echo esc_attr( $key ); ?> panel entry-content wc-tab" id="tab-<?php echo esc_attr( $key ); ?>" role="tabpanel" aria-labelledby="tab-title-<?php echo esc_attr( $key ); ?>">
