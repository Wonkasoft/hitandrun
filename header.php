...
<div id="page" class="site" style="background: url(<?php echo get_the_post_thumbnail_url(); ?>); background-size: cover;background-position: center center;background-repeat: no-repeat;">
	...
	<div class="col-sm cart-col">
		<a href="<?php get_permalink( woocommerce_get_page_id( 'shop' ) ); ?>"><i class="fa fa-shopping-cart"><span class="badge badge-light"><?php echo WC()->cart->get_cart_contents_count(); ?></span></i></a>
	</div> <!-- .cart-col -->
	</div> <!-- .row-w-nav -->
</div> <!-- .container-fluid -->
	</header><!-- #masthead -->
