...
<body <?php body_class(); ?> style="background: url(<?php echo get_the_post_thumbnail_url(); ?>); background-size: cover;background-position: center center;">
<div id="page" class="site">
	...
	<div class="col hour-number d-none d-md-block">
		...
		<div class="row row-number">
			<div class="col">
				<i class="fa fa-volume-control-phone"></i> <a href="/contact"><i class="fa fa-commenting-o"></i></a> <span class="hr-number"><a href="tel:9093901300">909-390-1300</a></span>
			</div> <!-- .col -->
		</div> <!-- .row -->
	</div> <!-- .col-4 -->
</div> <!-- .row-w-logo -->
